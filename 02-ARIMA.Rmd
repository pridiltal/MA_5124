...
In general the determinant in the numerator of Equations \@ref(eq:p1), \@ref(eq:p2) and \@ref(eq:p3) has the same elements as that in the denominator, but replacing the last column with $\mathbf{\rho_k}= (\rho_1, \rho_2,...\rho_k).$
