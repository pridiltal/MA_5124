...
When $k=2$, from Equation \@ref(eq:covma3)  and $E(\epsilon_{t-1}Y_{t-2}) = 0$ (future error and past observation) we get $\gamma_2=0$. Hence $\rho_2=0$. Similarly, we can show that
