...
\tightlist
\item
  Researchers get different results about the causality between inflation and economic growth.
\item
  Fisher (1993) verifies that causality goes from inflation to economic growth.
\item
  Contrary to Fisher, Umaru and Zubariu (2011) examined the causality between inflation and economic growth on Nigeria by using Granger causality test.
\item
  The test revealed that GDP causes inflation and not inflation causing GDP.
\item
  Studies also show that the causality relation can be different in the short run and in the long run.
\item
  Datta and Chanda(2011) study on Malaysia, have shown that causality exist between inflation and economic growth in the short run and direction of causality is from inflation to economic growth but in the long run economic growth causes inflation.
\end{itemize}
