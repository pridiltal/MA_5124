...
\KeywordTok{data}\NormalTok{(}\StringTok{"USMacroSW"}\NormalTok{) }
\NormalTok{TB3MS <-}\StringTok{ }\NormalTok{USMacroSW[,}\StringTok{"tbill"}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\KeywordTok{as.ts}\NormalTok{()}

\NormalTok{r1 <-}\StringTok{ }\KeywordTok{ur.df}\NormalTok{(}\KeywordTok{window}\NormalTok{(TB3MS, }\KeywordTok{c}\NormalTok{(}\DecValTok{1957}\NormalTok{, }\DecValTok{1}\NormalTok{), }\KeywordTok{c}\NormalTok{(}\DecValTok{2005}\NormalTok{, }\DecValTok{1}\NormalTok{)), }
            \DataTypeTok{lags =} \DecValTok{5}\NormalTok{, }
...
\NormalTok{TB10YS <-}\StringTok{ }\NormalTok{USMacroSW[,}\StringTok{"tbond"}\NormalTok{] }\OperatorTok{%>%}\StringTok{ }\KeywordTok{as.ts}\NormalTok{()}

\NormalTok{r1 <-}\StringTok{ }\KeywordTok{ur.df}\NormalTok{(}\KeywordTok{window}\NormalTok{(TB10YS, }\KeywordTok{c}\NormalTok{(}\DecValTok{1957}\NormalTok{, }\DecValTok{1}\NormalTok{), }\KeywordTok{c}\NormalTok{(}\DecValTok{2005}\NormalTok{, }\DecValTok{1}\NormalTok{)), }
...
\addcontentsline{toc}{section}{MA 5124 Financial Time Series Analysis \& Forecasting}
