...
- This multivariate time series is called a **multivariate white noise** if it is stationary with zero mean vector $\mathbf{0}$, and if the values of $\mathbf{\epsilon}_t$ at different times are uncorrelated.
